  ...
  return (
    <div className="navbar bg-base-100 shadow-sm">
      <div className="navbar-start">
        <div className="dropdown -ml-4 sm:ml-0">
          <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /> </svg>
          </div>
          <ul
            tabIndex="-1"
            className="menu menu-sm dropdown-content bg-[#0b8292] rounded-box mt-3 w-52 p-2 shadow z-50">
        ...
        {/* logo  */}
          <Link to='/' className=" font-bold text-2xl flex items-center gap-1 -ml-2 sm:ml-0">
    <img className=' w-13 sm:w-18 rounded-full ' src={logo} alt="" />
    <span className='text-[18px] sm:text-[24px]'>ContestHub</span>
    </Link>
      </div>
